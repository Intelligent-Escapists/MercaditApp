...
export default function Login() {
    ...
    const { user, login, logout, toggleRegister } = useContext(UserContext);
        ...
        <div className="flex justify-center items-center">
            <Card className='w-[450px] h-[400px]'>
                <CardHeader>
                    ...
                    <CardDescription>Si ya estás registrado, inicia sesión</CardDescription>
                </CardHeader>
                <CardContent>
                        ...
                        <div className="grid w-full gap-4">
                            <div className="flex flex-col items-start space-y-2">
                                ...
                                <Input
                                    ...
                                    onChange={correoInput.onChange}
                                    value={correoInput.value}
                                    required
                                    className={correoInput.error ? 'ring-offset-red-500 focus-visible:ring-red-500' : ''}
                                />
                            ...
                            <div className="flex flex-col items-start space-y-2">
                                ...
                                <Input
                                    ...
                                    required
                                    className={passwordInput.error ? 'ring-offset-red-500 focus-visible:ring-red-500' : ''}
                                />
                ...
                <CardFooter>
                    <small className="mr-2">¿No tienes cuenta?</small>
                    <small>
                        <Link to="/registro" className="text-blue-500 font-medium" onClick={toggleRegister}>
                            Registrate
                        </Link>
                    </small>
                </CardFooter>
